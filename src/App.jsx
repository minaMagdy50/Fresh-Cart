...
export default function App() {
  ...
  let routers = createBrowserRouter([
    ...
    {index: true , element:  <Suspense><ProtectedRoute><Home/></ProtectedRoute></Suspense>},
    {path:'brands' , element: <Suspense><ProtectedRoute><Brands/></ProtectedRoute></Suspense> },
    {path:'products' , element: <Suspense><ProtectedRoute><Products/></ProtectedRoute></Suspense>},
    {path:'productDetails/:id' , element: <Suspense><ProtectedRoute><ProductDetails/></ProtectedRoute></Suspense>},
    {path:'categories' , element: <Suspense><ProtectedRoute><Categories/></ProtectedRoute></Suspense>},
